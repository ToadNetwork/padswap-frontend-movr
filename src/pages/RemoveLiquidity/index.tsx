...
import { Currency, currencyEquals, ETHER, Percent, WETH } from '@padswap/sdk'
import { Button, Flex, Text } from '@padswap/uikit'
                      ...
                      {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                        <RowBetween style={{ justifyContent: 'flex-end' }}>
                          {oneCurrencyIsETH ? (
                            ...
                            >
                              {TranslateString(1188, 'Receive WMOVR')}
                            </StyledInternalLink>
                          ) : oneCurrencyIsWETH ? (
                            <StyledInternalLink
                              to={`/remove/${
                            ...
                            >
                              {TranslateString(1190, 'Receive MOVR')}
                            </StyledInternalLink>
                          ) : null}
                        </RowBetween>
                      ) : null}
