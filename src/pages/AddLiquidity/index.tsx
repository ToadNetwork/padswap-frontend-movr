...
import { Currency, currencyEquals, ETHER, TokenAmount, WETH } from '@padswap/sdk'
import { Button, CardBody, AddIcon, Text as UIKitText } from '@padswap/uikit'
  ...
  const handleCurrencyBSelect = useCallback(
    (currB: Currency) => {
      ...
      if (currencyIdA === newCurrencyIdB) {
        ...
        history.push(`/add/${currencyIdA || 'MOVR'}/${newCurrencyIdB}`)
      }
    },
